...
from staicoin.consensus.network_type import NetworkType
from staicoin.consensus.pot_iterations import calculate_iterations_quality, calculate_sp_interval_iters
from staicoin.farmer.farmer import Farmer
from staicoin.farmer.pooling.og_pool_protocol import PartialPayload, SubmitPartial
from staicoin.protocols import farmer_protocol, harvester_protocol
from staicoin.protocols.harvester_protocol import PoolDifficulty
...
from staicoin.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSstaicoinConnection
    ):
        """
            ...
            for sk in self.farmer.get_private_keys():
                ...
                if pk == response.farmer_pk:
                    ...
                    request = farmer_protocol.DeclareProofOfSpace(
                        ...
                        self.farmer.officialwallets_target,
                        pool_target,
