...
from stai.farmer.pooling.og_pool_protocol import PartialPayload, SubmitPartial
from stai.protocols import farmer_protocol, harvester_protocol
from stai.protocols.harvester_protocol import PoolDifficulty
...
from stai.util.api_decorators import api_request, peer_required
...
class FarmerAPI:
    ...
    async def new_proof_of_space(
        self, new_proof_of_space: harvester_protocol.NewProofOfSpace, peer: ws.WSStaiConnection
    ):
        """
    ...
    @api_request
    @peer_required
    async def respond_plots(self, _: harvester_protocol.RespondPlots, peer: ws.WSStaiConnection):
